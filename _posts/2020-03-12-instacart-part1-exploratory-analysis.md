...
_"prior": orders prior to that users most recent order; "train": training data supplied to participants of the competition; "test": test data reserved for machine learning competition_
